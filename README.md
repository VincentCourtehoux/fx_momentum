...
* **Dynamic Portfolio Construction:** Simulation of 5 distinct currency portfolios (Safe Havens, Emerging Markets, High Yielders).
* **Backtesting Engine:** Monthly rebalancing logic with transaction cost simulation.
* **Regime Analysis:** Comparative performance analysis across three eras:
    * *Pre-2008:* The "Golden Era" of momentum.
    * *GFC & Euro Crisis:* Volatility and Crash periods.
    * *Post-2012:* Analysis of momentum decay in the QE (Quantitative Easing) era.
